...
echo form_open(base_url('admin/user/create'),' class="form-horizontal"');
?>
...
<div class="form-group">
   ...
   <div class="col-md-8">
     <input type="text" class="form-control" name= "name" placeholder="Masukkan Nama Pengguna" value = "<?php echo set_value('name'); ?>" required />
   </div>
 </div>
 ...
 <div class="form-group">
   ...
   <div class="col-md-8">
     <input type="email" class="form-control" name= "email" placeholder="Masukkan Email Pengguna" value = "<?php echo set_value('email'); ?>" required />
   </div>
 </div>
 ...
 <div class="form-group">
   ...
   <div class="col-md-8">
     <input type="text" class="form-control" name= "username" placeholder="Masukkan Username" value = "<?php echo set_value('username'); ?>" required />
   </div>
 </div>
