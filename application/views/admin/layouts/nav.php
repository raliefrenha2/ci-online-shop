    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin/configuration') ?>"><i class="fa fa-home"></i> Konfigurasi Umum</a></li>
            <li><a href="<?php echo base_url('admin/configuration/logo') ?>"><i class="fa fa-image"></i> Konfigurasi Logo</a></li>
             <li><a href="<?php echo base_url('admin/configuration/icon') ?>"><i class="fa fa-home"></i> Konfogurasi Icon</a></li>
          </ul>
        </li>
